/**
 * Agora Demo AI Response Engine
 * Provides realistic, deterministic responses with progressive streaming for the Demo Runtime.
 *
 * NOTE: This is a hackathon demonstration mode. Responses are generated locally
 * to demonstrate the complete Agora product flow even when Ollama is unavailable.
 */
